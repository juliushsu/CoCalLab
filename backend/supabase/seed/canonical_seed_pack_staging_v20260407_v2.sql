-- CaCalLab Canonical Seed Pack v2 (staging showcase)
...
set
  ...
  title = 'Staging Core Closed Beta Canonical Pack (Showcase v2)',
  description = 'Showcase-grade canonical seed with trend/hotspot-ready activities and multi-adjustment chains.',
...
values (
  ...
  'started',
  'codex',
  jsonb_build_object('note', 'showcase v2 reseed start')
);
...
values (
  ...
  '{"seed_pack":"v2026.04.07.v2"}'::jsonb,
  'staging',
  true
);

insert into projects (
  id, organization_id, project_code, name, description, reporting_start_date, reporting_end_date, boundary_type, status, env, is_test
)
values
(
...
insert into report_generations (
  ...
  gross_emissions_snapshot, adjustment_summary, claim_results, adjustment_manifest, claim_purpose, env, is_test
)
values
(
  ...
  1,
  jsonb_build_object(
    'project_metadata', jsonb_build_object('project_id','a3333333-1111-4111-8111-111111111111','project_code','STG-PJT-SHOWCASE-001','name','[STG] Showcase Inventory 2026'),
    'reporting_period', jsonb_build_object('start_date','2026-01-01','end_date','2026-03-31'),
    'boundary_summary', jsonb_build_object('included_count',6,'excluded_count',0,'pending_count',0),
...
(
  ...
  jsonb_build_object(
    ...
    'boundary_summary', jsonb_build_object('included_count',11,'excluded_count',0,'pending_count',1),
...
values
('c1330001-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111','d9000002-1111-4111-8111-111111111111','c1110001-1111-4111-8111-111111111111','c1220001-1111-4111-8111-111111111111','internal_management',3.0,2.4,0.6,'[]'::jsonb,'market_based_adjustment','applied','showcase-v2-app-001','showcase-v2-app-hash-001','27141206-6e54-40d0-8b9d-7dc60832bdd7','27141206-6e54-40d0-8b9d-7dc60832bdd7','2026-06-30T10:00:00Z','2026-06-30T10:05:00Z','2026-06-30T10:10:00Z','{"source":"seed_pack_v2"}'::jsonb,'staging',true),
('c1330002-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111',null,'c1110002-1111-4111-8111-111111111111','c1220002-1111-4111-8111-111111111111','voluntary_claim',6.0,6.0,0.0,'[]'::jsonb,'claim_only','approved','showcase-v2-app-002','showcase-v2-app-hash-002','27141206-6e54-40d0-8b9d-7dc60832bdd7','27141206-6e54-40d0-8b9d-7dc60832bdd7','2026-06-28T09:00:00Z','2026-06-28T09:05:00Z',null,'{"source":"seed_pack_v2"}'::jsonb,'staging',true),
('c1330003-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111',null,'c1110003-1111-4111-8111-111111111111','c1220003-1111-4111-8111-111111111111','ifrs_s2_note',5.0,0.0,5.0,'["certificate_not_verified","item_not_approved"]'::jsonb,'claim_only','submitted','showcase-v2-app-003','showcase-v2-app-hash-003','27141206-6e54-40d0-8b9d-7dc60832bdd7',null,'2026-06-29T09:00:00Z',null,null,'{"source":"seed_pack_v2"}'::jsonb,'staging',true);
...
values
('c1440001-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111','27141206-6e54-40d0-8b9d-7dc60832bdd7','seed_v2_application_applied','adjustment_applications','c1330001-1111-4111-8111-111111111111','c1110001-1111-4111-8111-111111111111','c1220001-1111-4111-8111-111111111111','c1330001-1111-4111-8111-111111111111','recorded','{"source":"seed_pack_v2"}'::jsonb,'staging',true),
('c1440002-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111','27141206-6e54-40d0-8b9d-7dc60832bdd7','seed_v2_application_approved','adjustment_applications','c1330002-1111-4111-8111-111111111111','c1110002-1111-4111-8111-111111111111','c1220002-1111-4111-8111-111111111111','c1330002-1111-4111-8111-111111111111','recorded','{"source":"seed_pack_v2"}'::jsonb,'staging',true),
('c1440003-1111-4111-8111-111111111111','a1111111-1111-4111-8111-111111111111','a3333333-1111-4111-8111-111111111111','27141206-6e54-40d0-8b9d-7dc60832bdd7','seed_v2_application_submitted','adjustment_applications','c1330003-1111-4111-8111-111111111111','c1110003-1111-4111-8111-111111111111','c1220003-1111-4111-8111-111111111111','c1330003-1111-4111-8111-111111111111','recorded','{"source":"seed_pack_v2"}'::jsonb,'staging',true);
...
where id = (
  ...
  where scenario_code = 'stg_core_closed_beta'
    and seed_pack_version = 'v2026.04.07.v2'
    and status = 'started'
