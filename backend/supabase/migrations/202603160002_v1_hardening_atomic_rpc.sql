-- CaCalLab V1 hardening: confirm-draft atomic RPC
...
declare
  ...
  v_inclusion_status inclusion_status := 'excluded';
begin
  ...
  if p_decision = 'confirmed' then
    ...
    returning id, inclusion_status into v_emission_activity_id, v_inclusion_status;

    update calculation_results
    set is_latest = false
    where emission_activity_id = v_emission_activity_id
      and is_latest = true;
